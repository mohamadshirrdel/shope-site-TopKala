function loadShopCartJs() {
  ...
  $(document).on(
    "click",
    "#offcanvas-dismiss-cart, #offcanvas-dismiss-menu, .offcanvas-overlay",
    function () {
...
$(document).ready(function () {
  ...
  //    quantity-selector
  $(
    "nav.navbar ul.navbar-ul li.nav-item ul.mega-menu li.menu-mega-item .mega-menu-sublist-row",
  ).hover(function () {
    ...
    $countdownOptionEnd.countdown({
      ...
      text: '<span class="day">%s</span><span class="hour">%s</span><span>: %s</span><span>%s</span>',
        ...
        $countdownOptionEnd.html(
          "<a href='' class='link-border-verify form-account-link'>دریافت مجدد کد تأیید</a>",
        );
      },
    });
  }
  ...
  // kamadatepicker
  kamaDatepicker("test-date-id-one", {
    buttonsColor: "red",
    forceFarsiDigits: true,
  });
  kamaDatepicker("test-date-id-two", {
    buttonsColor: "red",
    forceFarsiDigits: true,
  });
